...
urlpatterns = [
    ...
    path('cars/<int:pk>/assigndriver/', assign_driver_to_car, name='assign-driver-to-car'),
    path('cars/<int:pk>/deletedriver/', delete_driver_from_car, name='delete-driver-from-car'),
